...
#define CONFIGURE_ARGS " '--prefix' '/Users/runner/work/postgresql-binaries/postgresql-binaries/postgresql-18.4.0-aarch64-apple-darwin' '--enable-integer-datetimes' '--enable-option-checking=fatal' '--without-icu' '--without-ldap' '--with-libxml' '--with-libxslt' '--with-openssl' '--with-pgport=5432' '--with-readline' '--with-system-tzdata=/usr/share/zoneinfo' '--with-uuid=e2fs' 'LDFLAGS=-L/opt/homebrew/opt/icu4c/lib -L/opt/homebrew/opt/openssl/lib' 'CPPFLAGS=-I/opt/homebrew/opt/icu4c/include -I/opt/homebrew/opt/openssl/include' 'LLVM_CONFIG=/opt/homebrew/opt/llvm/bin/llvm-config'"
